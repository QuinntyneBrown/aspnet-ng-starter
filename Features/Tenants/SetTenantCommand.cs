...
namespace AspNetNgStarter.Features.Tenants
{
    ...
    public class SetTenantCommand
    {
        ...
        {
            public Handler(AspNetNgStarterContext context, HttpClient client)
            {
                _context = context;
                _client = client;
            }
            ...
            private readonly AspNetNgStarterContext _context;            
